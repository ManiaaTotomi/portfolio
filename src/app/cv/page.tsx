...
const EXPERIENCE_ENTRIES: ExperienceEntry[] = [
  ...
  },
  {
    ...
    company: "freelancing product designer",
    role: "Product Designer",
    bullets: [
...
function SectionHeader({ label }: { label: string }) {
  return (
    <div className="space-y-2">
      <p className="font-figtree text-[14px] font-bold uppercase tracking-[0.7px] text-[#f3f3f3]">
        {label}
      </p>
      ...
      <div className="px-4 py-6 sm:px-8 sm:py-8 lg:px-12 lg:py-10">
        <article className="mx-auto w-full max-w-[1040px] rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,#111113_0%,#0d0d0f_100%)] p-6 shadow-[0_20px_70px_rgba(0,0,0,0.35)] sm:p-10 lg:p-[52px]">
          ...
          <section className="mt-10 space-y-4">
            ...
            <p className="font-figtree max-w-[980px] text-[16px] leading-[1.72] text-[#d4d4d4]">
            ...
            <div className="space-y-7">
              {EXPERIENCE_ENTRIES.map((entry) => (
                <div className="grid gap-3 lg:grid-cols-[190px_1fr] lg:gap-8" key={`${entry.period}-${entry.role}`}>
                  <div>
                    <p className="font-figtree text-[16px] font-bold leading-[1.5] text-white">
                      {entry.period} /
                    </p>
                    <p className="font-figtree text-[16px] leading-[1.5] text-white/48">{entry.company}</p>
                  </div>
                  <div>
                    <p className="font-figtree text-[16px] font-bold leading-[1.5] text-white">
                      {entry.role}
                    ...
                    <ul className="mt-2 space-y-0.5">
                      {entry.bullets.map((bullet) => (
                        <li
                          className="font-figtree text-[16px] leading-[1.72] text-[#d4d4d4]"
          ...
          <section className="mt-10 space-y-4">
            ...
            <p className="font-figtree text-[16px] leading-[1.65] text-[#d4d4d4]">
